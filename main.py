...
parser.add_argument('--method', type=str, default='onenet_lsnet2') #'onenet_fsnet' 'onenet_tcn''fsnet''derpp''er''naive_time''naive''patch' 'lsnetAblation' ‘onenet_lsnet1_RES’
...
parser.add_argument('--online_learning', type=str, default='full')#regressor
...
parser.add_argument('--lr_test', type=float, default=0.01, help='learning rate during test')
...
parser.add_argument('--moving_avg', default=[6], help='window size of moving average')
...
data_parser = {
    ...
    'Weather': {'data': 'Weather.csv', 'T':'OT', 'M':[21,21,21]},
    'PCpower': {'data': 'PCpower.csv', 'T':'OT', 'M':[25,25,25]},
}
...
np.savetxt(folder_path + 'metrics.csv', np.array(metrics))
